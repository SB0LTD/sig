...
const CodeGen = @import("../codegen/spirv/CodeGen.sig");
const BinaryModule = @import("SpirV/BinaryModule.sig");
const lower_invocation_globals = @import("SpirV/lower_invocation_globals.sig");
const dedup_types = @import("SpirV/dedup_types.sig");
const prune_unused = @import("SpirV/prune_unused.sig");
const spec = @import("../codegen/spirv/spec.sig");
const Section = @import("../codegen/spirv/Section.sig");
const Id = spec.Id;
const Word = spec.Word;
const Mir = @import("../codegen/spirv/Mir.sig");
...
fn mergeFragments(linker: *Linker, gpa: Allocator, arena: Allocator) error{OutOfMemory}!MergedModule {
    ...
    // Resolve Sig extern navs against external objects.
