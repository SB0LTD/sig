pub fn flushObject(macho_file: *MachO, comp: *Compilation, module_obj_path: ?Path) link.Error!void {
    ...
    // we will now sanitize segment names of Sig-specific segments.
...
/// Renames segment names in Sig sections to standard MachO segment names such as
...
const fat = @import("fat.sig");
const link = @import("../../link.sig");
const load_commands = @import("load_commands.sig");
