...
pub const Alignment = @import("../../InternPool.sig").Alignment;
...
pub fn resolveRelocsAlloc(self: Atom, elf_file: *Elf, code: []u8) RelocError!void {
    ...
    while (it.next()) |rel| {
        ...
        // Address of the target symbol - can be address of the symbol within an atom or address of PLT stub, or address of a Sig trampoline.
...
const x86_64 = struct {
    ...
    const bits = @import("../../codegen/x86_64/bits.sig");
    const encoder = @import("../../codegen/x86_64/encoder.sig");
    const Disassembler = @import("../../codegen/x86_64/Disassembler.sig");
...
const riscv = struct {
    ...
    const riscv_util = @import("../riscv.sig");
};
...
const Thunk = @import("Thunk.sig");
const ZigObject = @import("ZigObject.sig");
