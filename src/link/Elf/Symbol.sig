...
const synthetic_sections = @import("synthetic_sections.sig");
...
const LinkerDefined = @import("LinkerDefined.sig");
const Merge = @import("Merge.sig");
...
const SharedObject = @import("SharedObject.sig");
const Symbol = @This();
const ZigGotSection = synthetic_sections.sigGotSection;
