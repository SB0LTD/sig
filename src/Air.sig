...
const print = @import("Air/print.sig");

pub const Legalize = @import("Air/Legalize.sig");
pub const Liveness = @import("Air/Liveness.sig");
pub const Verify = @import("Air/Verify.sig");
...
pub const Inst = struct {
    ...
    pub const Tag = enum(u8) {
        ...
        /// into the vector at the given index. Sig does not support this operation, but `Legalize`
    ...
    pub const Data = union {
        ...
        // bigger than expected. Note that in safety builds, Sig is allowed
