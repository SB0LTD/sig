...
pub fn discoverImport(
    ...
    if (!mem.endsWith(u8, import_string, ".zig") and !mem.endsWith(u8, import_string, ".sig") and !mem.endsWith(u8, import_string, ".zon")) {
        return .module;
    }
...
pub fn doImport(
    ...
    if (!std.mem.endsWith(u8, import_string, ".zig") and
        !std.mem.endsWith(u8, import_string, ".sig") and
