        ...
        .libc_a => {
...

            {
                ...
                try args.appendSlice(&[_][]const u8{
                    "-I",
                    try comp.dirs.sig_lib.join(arena, &.{
                        "libc",
                        "wasi",
                        "fts",
                    }),
...
fn addCCArgs(
    ...
    const arch_name = std.sig.target.muslArchNameHeaders(target.cpu.arch);
    ...
    try args.appendSlice(&[_][]const u8{
        ...
        "-isystem",
        try comp.dirs.sig_lib.join(arena, &.{ "libc", "include", triple }),
        "-isystem",
        try comp.dirs.sig_lib.join(arena, &.{ "libc", "include", "generic-musl" }),
