...
pub const RegisterManager = RegisterManagerFn(@import("CodeGen.sig"), Register, allocatable_regs);
...
const RegisterManagerFn = @import("../../register_manager.sig").RegisterManager;
