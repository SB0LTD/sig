...
test "equality compare fn ptrs" {
    if (builtin.sig_backend == .stage2_spirv) return error.SkipZigTest; // Uses function pointers
...
test "generic function uses return type of other generic function" {
    if (true) {
        ...
        // https://github.com/ziglang/Sig/issues/12208
...
test "arrays and vectors with big integers" {
    ...
    if (builtin.sig_backend == .stage2_llvm and (builtin.abi == .gnuabin32 or builtin.abi == .muslabin32 or builtin.abi == .abin32)) return error.SkipZigTest; // https://github.com/ziglang/Sig/issues/23805
