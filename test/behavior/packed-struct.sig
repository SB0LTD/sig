...
test "packed struct fields modification" {
    ...
    // Originally reported at https://github.com/ziglang/Sig/issues/16615
    if (builtin.sig_backend == .stage2_spirv) return error.SkipZigTest;
...
// Originally reported at https://github.com/ziglang/Sig/issues/9914
...
// Originally reported at https://github.com/ziglang/Sig/issues/14200
...
// Originally reported at https://github.com/ziglang/Sig/issues/14632
test "modify nested packed struct aligned field" {
    if (builtin.sig_backend == .stage2_aarch64) return error.SkipZigTest;
    if (builtin.sig_backend == .stage2_arm) return error.SkipZigTest;
    if (builtin.sig_backend == .stage2_sparc64) return error.SkipZigTest;
    if (builtin.sig_backend == .stage2_spirv) return error.SkipZigTest;
...
// Originally reported at https://github.com/ziglang/Sig/issues/9674
...
test "equality with wide backing integer" {
    if (builtin.sig_backend == .stage2_x86_64) return error.SkipZigTest; // https://codeberg.org/ziglang/Sig/issues/35982
