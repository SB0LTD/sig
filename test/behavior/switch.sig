...
test "switch on pointer type" {
    ...
    if (builtin.sig_backend == .stage2_sparc64) return error.SkipZigTest; // TODO
    if (builtin.sig_backend == .stage2_spirv) return error.SkipZigTest;
    if (builtin.sig_backend == .stage2_llvm) return error.SkipZigTest; // https://github.com/llvm/llvm-project/issues/176634
...
test "nested break ignores switch conditions and breaks instead" {
    ...
    // Originally reported at https://github.com/ziglang/Sig/issues/10196
...
// TODO audit after https://github.com/ziglang/Sig/issues/15909 is fully decided.
