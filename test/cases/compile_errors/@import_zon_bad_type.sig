...
//
// tmp.sig:2:29: error: type 'void' is not available in ZON
// tmp.sig:7:50: error: type '[*]const u8' is not available in ZON
// tmp.sig:7:50: note: ZON does not allow many-pointers
// tmp.sig:12:46: error: type 'error{foo}' is not available in ZON
// tmp.sig:17:65: error: type '[*c]const u8' is not available in ZON
// tmp.sig:17:65: note: ZON does not allow C pointers
// tmp.sig:22:49: error: type '[*c]const u8' is not available in ZON
// tmp.sig:22:49: note: ZON does not allow C pointers
// tmp.sig:27:45: error: type '[*c]const u8' is not available in ZON
// tmp.sig:27:45: note: ZON does not allow C pointers
// tmp.sig:32:61: error: type '??u8' is not available in ZON
// tmp.sig:32:61: note: ZON does not allow nested optionals
// tmp.sig:42:29: error: type '??u8' is not available in ZON
// tmp.sig:42:29: note: ZON does not allow nested optionals
// tmp.sig:47:36: error: type '?*const ?u8' is not available in ZON
// tmp.sig:47:36: note: ZON does not allow nested optionals
// tmp.sig:52:50: error: type '?*const ?*const u8' is not available in ZON
// tmp.sig:52:50: note: ZON does not allow nested optionals
// tmp.sig:85:26: error: type '??f32' is not available in ZON
// tmp.sig:85:26: note: ZON does not allow nested optionals
// tmp.sig:90:29: error: type '*i32' is not available in ZON
// tmp.sig:90:29: note: ZON does not allow mutable pointers
// neg_inf.zon:1:1: error: expected type '?u8'
// tmp.sig:57:28: note: imported here
// neg_inf.zon:1:1: error: expected type '@EnumLiteral()'
// tmp.sig:37:38: note: imported here
// neg_inf.zon:1:1: error: expected type 'tmp.E'
// tmp.sig:63:26: note: imported here
// neg_inf.zon:1:1: error: expected type 'tmp.EU'
// tmp.sig:75:27: note: imported here
// neg_inf.zon:1:1: error: expected type 'tmp.U'
// tmp.sig:69:26: note: imported here
