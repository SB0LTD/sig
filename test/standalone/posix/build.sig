...
const cases = [_]Case{
    ...
    .{
        .src_path = "sigaction.sig",
    },
    .{
        .src_path = "relpaths.sig",
        .make_tmp_dir = true,
    },
};
...
fn run_exe(b: *std.Build, optimize: std.builtin.Optimize, case: *const Case, target: std.Build.ResolvedTarget, link_libc: bool) *std.Build.Step.Run {
