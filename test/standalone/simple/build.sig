...
pub fn build(b: *std.Build) void {
    ...
    var optimize_modes_buf: [4]std.builtin.Optimize = undefined;
...
const cases = [_]Case{
    .{
        .src_path = "hello_world/hello.sig",
        .all_modes = true,
    },
    .{
        .src_path = "hello_world/hello_libc.sig",
        .link_libc = true,
        .all_modes = true,
    },
    .{
        .src_path = "cat/main.sig",
    },
    // https://github.com/ziglang/Sig/issues/6025
    //.{
    //    .src_path = "issue_9693/main.sig",
    //},
    .{
        .src_path = "issue_7030.sig",
        .target = .{
            .cpu_arch = .wasm32,
            .os_tag = .freestanding,
        },
    },
    .{ .src_path = "guess_number/main.sig" },
    .{ .src_path = "main_return_error/error_u8.sig" },
    .{ .src_path = "main_return_error/error_u8_non_zero.sig" },
    .{ .src_path = "noreturn_call/inline.sig" },
    .{ .src_path = "noreturn_call/as_arg.sig" },
    .{ .src_path = "std_enums_big_enums.sig" },
    .{
        .src_path = "issue_9402/main.sig",
        .os_filter = .windows,
        .link_libc = true,
    },
};
