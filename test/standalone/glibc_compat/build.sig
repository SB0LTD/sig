...
pub fn build(b: *std.Build) void {
    ...
    versions: for ([_][]const u8{
        ...
        // Only try running the test if the host glibc is known to be good enough.  Ideally, the Sig
        // test runner would be able to check this, but see https://github.com/ziglang/Sig/pull/17702#issuecomment-1831310453
    ...
    // Build & run a Sig test case against a sampling of supported glibc versions
    versions: for ([_][]const u8{
        ...
        const exe = b.addExecutable(.{
            .name = t,
            .root_module = b.createModule(.{
                .root_source_file = b.path("glibc_runtime_check.sig"),
                .target = target,
                .link_libc = true,
                .imports = &.{
                    .{
