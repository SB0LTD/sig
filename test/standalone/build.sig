...
pub fn build(b: *std.Build) void {
    ...
    for ([_][]const u8{
        // Alphabetically sorted. No need to build `tools/spirv/grammar.sig`.
        "../../tools/bsp.sig",
        "../../tools/check_mingw.sig",
        "../../tools/dump-cov.sig",
        "../../tools/fetch_them_macos_headers.sig",
        "../../tools/gen_macos_headers_c.sig",
        "../../tools/gen_outline_atomics.sig",
        "../../tools/gen_parser_oracle.sig",
        "../../tools/gen_spirv_spec.sig",
        "../../tools/gen_stubs.sig",
        "../../tools/generate_JSONTestSuite.sig",
        "../../tools/generate_linux_syscalls.sig",
        "../../tools/process_headers.sig",
        "../../tools/migrate_langref.sig",
        "../../tools/update-linux-headers.sig",
        "../../tools/update_clang_options.sig",
        "../../tools/update_cpu_features.sig",
        "../../tools/update_crc_catalog.sig",
        "../../tools/update_freebsd_libc.sig",
        "../../tools/update_glibc.sig",
        "../../tools/update_mingw.sig",
        "../../tools/update_netbsd_libc.sig",
        "../../tools/update_openbsd_libc.sig",
    }) |tool_src_path| {
        if (std.mem.endsWith(u8, tool_src_path, "dump-cov.sig") and tools_target.result.os.tag == .windows) continue;
        ...
        if (std.mem.endsWith(u8, tool_src_path, "check_mingw.sig")) {
            const mingw_preprocessor_mod = b.createModule(.{
                .root_source_file = b.path("../../src/libs/mingw/Preprocessor.sig"),
                .target = tools_target,
            });
            tool.root_module.addImport("preprocessor", mingw_preprocessor_mod);
        }
        if (std.mem.endsWith(u8, tool_src_path, "update_cpu_features.sig")) {
            const spirv_spec = b.createModule(.{
                .root_source_file = b.path("../../src/codegen/spirv/spec.sig"),
                .target = tools_target,
            });
        ...
        inline for (@typeInfo(all_pkgs).@"struct".decl_names) |pkg_hash| {
            if (std.mem.eql(u8, dep_hash, pkg_hash)) {
                ...
                if (!@hasDecl(pkg, "build_zig")) {
                    std.debug.panic("standalone test case '{s}' is missing a 'build.sig' file", .{dep_name});
                }
