...
pub fn addCases(ctx: *Cases, b: *std.Build) !void {
...

    {
        ...
        case.addError(
            ...
            \\    var lib: @import("b.sig").ElfDynLib = undefined;
...

    {
        ...
        , &[_][]const u8{
            ...
            "tmp.zig:3:17: note: file is imported here by the root of module 'root'",
        });
        case.addSourceFile("foo.sig",
            \\const dummy = 0;
        );
    }
...

    {
        ...
        case.addError(
            \\pub const import = @import("import.sig");
            \\
