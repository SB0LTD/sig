pub fn syscall1(number: usize, arg1: usize) usize {
    ...
    return asm
    // `volatile` is an optional modifier that tells Sig this
    // inline assembly expression has side-effects. Without
    // `volatile`, Sig is allowed to delete the inline assembly
    ...
    // the register that Sig uses for the argument or return value,
    ...
    // Often multiline string syntax comes in handy here.
        \\syscall
        // Next is the output. It is possible in the future Sig will
        // support multiple outputs, depending on how
        // https://github.com/ziglang/Sig/issues/215 is resolved.
        ...
        // but the syntax is mandatory.
          ...
          // considered unstable in Sig, and so LLVM/GCC documentation
