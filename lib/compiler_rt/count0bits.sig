...
test {
    _ = @import("clzsi2_test.sig");
    _ = @import("clzdi2_test.sig");
    _ = @import("clzti2_test.sig");

    _ = @import("ctzsi2_test.sig");
    _ = @import("ctzdi2_test.sig");
    _ = @import("ctzti2_test.sig");

    _ = @import("ffssi2_test.sig");
    _ = @import("ffsdi2_test.sig");
    _ = @import("ffsti2_test.sig");
}
