...
pub const Document = @import("markdown/Document.sig");
pub const Parser = @import("markdown/Parser.sig");
pub const Renderer = @import("markdown/renderer.sig").Renderer;
pub const renderNodeInlineText = @import("markdown/renderer.sig").renderNodeInlineText;
pub const fmtHtml = @import("markdown/renderer.sig").fmtHtml;
...
test "headings with inline content" {
    try testRender(
        ...
        \\
    ,
        \\<h1>Outline of <code>std.sig</code></h1>
