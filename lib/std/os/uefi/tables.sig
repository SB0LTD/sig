...
pub const BootServices = @import("tables/boot_services.sig").BootServices;
pub const RuntimeServices = @import("tables/runtime_services.sig").RuntimeServices;
pub const ConfigurationTable = @import("tables/configuration_table.sig").ConfigurationTable;
pub const SystemTable = @import("tables/system_table.sig").SystemTable;
pub const TableHeader = @import("tables/table_header.sig").TableHeader;
