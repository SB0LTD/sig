    ...
    var base: usize = maxInt(usize);
    {
        ...
        while (i < eh.e_phnum) : ({
            ...
            switch (this_ph.type) {
                ...
                // of the memory space (e.g. vaddr = 0xffffffffff700000 on WSL1).
                ...
                .LOAD => base = vdso_addr +% this_ph.offset -% this_ph.vaddr,
                .DYNAMIC => maybe_dynv = @as([*]usize, @ptrFromInt(vdso_addr + this_ph.offset)),
                else => {},
            }
        }
    }
