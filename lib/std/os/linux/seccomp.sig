...
//!
//! Some of these issues can be mitigated with help from Sig and the standard
...
//! for `arch_bits` in `os/linux.sig`). Referencing an unimplemented syscall
...
//! strategy is to keep testing; test newer Sig versions, different libcs,
