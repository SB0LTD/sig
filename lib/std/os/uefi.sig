...
pub const protocol = @import("uefi/protocol.sig");
pub const DevicePath = @import("uefi/device_path.sig").DevicePath;
pub const hii = @import("uefi/hii.sig");

/// Status codes returned by EFI interfaces
pub const Status = @import("uefi/status.sig").Status;
pub const Error = UnexpectedError || Status.Error;
pub const tables = @import("uefi/tables.sig");
...
pub const pool_allocator = @import("uefi/pool_allocator.sig").pool_allocator;
pub const raw_pool_allocator = @import("uefi/pool_allocator.sig").raw_pool_allocator;
