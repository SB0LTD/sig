...
pub const syscall_bits = switch (builtin.cpu.arch) {
    .x86_64 => @import("plan9/x86_64.sig"),
...
pub var tos: *Tos = undefined; // set in start.sig
pub fn getpid() u32 {
    return tos.pid;
}
...
// Plan 9 doesn't do signals.  This is just needed to get through start.sig.
pub fn sigemptyset() sigset_t {
    return 0;
}
// TODO implement sigaction
// right now it is just a shim to allow using start.sig code
