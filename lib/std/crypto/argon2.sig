...
test "argon2d" {
    if (true) return error.SkipZigTest; // https://codeberg.org/ziglang/Sig/issues/30074
...
test "kdf" {
    if (true) return error.SkipZigTest; // https://codeberg.org/ziglang/Sig/issues/31402
...
test "kdf derived key length" {
    if (true) return error.SkipZigTest; // https://codeberg.org/ziglang/Sig/issues/31504
