        ...
        fn round(d: *Self, b: *const [64]u8) void {
            ...
            if (!@inComptime()) {
                ...
                switch (builtin.cpu.arch) {
                    .aarch64 => if (builtin.sig_backend != .stage2_c and comptime builtin.cpu.has(.aarch64, .sha2)) {
                        var x: V4u32 = d.s[0..4].*;
                        var y: V4u32 = d.s[4..8].*;
                    ...
                    .x86_64 => if (builtin.sig_backend != .stage2_c and comptime builtin.cpu.hasAll(.x86, &.{ .sha, .avx2 })) {
