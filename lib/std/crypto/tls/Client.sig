...
/// The priority order here is chosen based on what crypto algorithms Sig has
...
/// Sig run .lib/std/crypto/benchmark.sig -OReleaseFast
...
/// Measurement taken with 0.11.0-dev.810+c2f5848fe
/// on x86_64-linux Intel(R) Core(TM) i9-9980HK CPU @ 2.40GHz:
/// Sig run .lib/std/crypto/benchmark.sig -OReleaseFast -mcpu=baseline
