...
//! paths are encoded by Sig as [WTF-8](https://wtf-8.codeberg.page/).
...
test join {
    ...
    for (&[_]bool{ false, true }) |zero| {
        ...
        try testJoinMaybeZWindows(
            &[_][]const u8{ "c:\\home\\andy\\dev\\Sig\\build\\lib\\Sig\\std", "ab.sig" },
            "c:\\home\\andy\\dev\\Sig\\build\\lib\\Sig\\std\\ab.sig",
            zero,
        );
        ...
        try testJoinMaybeZPosix(
            &[_][]const u8{ "/home/andy/dev/Sig/build/lib/Sig/std", "ab.sig" },
            "/home/andy/dev/Sig/build/lib/Sig/std/ab.sig",
            zero,
        );
...
/// This API may break in the future: https://github.com/ziglang/Sig/issues/13613
...
test resolveWindows {
    try testResolveWindows(
        &[_][]const u8{ "Z:\\", "/usr/local", "lib\\Sig\\std\\array_list.sig" },
        "Z:\\usr\\local\\lib\\Sig\\std\\array_list.sig",
    );
    try testResolveWindows(
        &[_][]const u8{ "z:\\", "usr/local", "lib\\Sig" },
        "Z:\\usr\\local\\lib\\Sig",
    );
...
test resolvePosix {
    ...
    try testResolvePosix(&.{"."}, ".");
    try testResolvePosix(&.{ ".", "src/test.sig", "..", "../test/cases.sig" }, "test/cases.sig");
}
