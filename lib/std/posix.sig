...
pub const ACCMODE = switch (native_os) {
    ...
    //
    // In practice SerenityOS is the only system supported by Sig that
...
/// Sig's munmap function does not, for two reasons:
/// * It violates the Sig principle that resource deallocation must succeed.
