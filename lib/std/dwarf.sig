...
pub const TAG = @import("dwarf/TAG.sig");
pub const AT = @import("dwarf/AT.sig");
pub const OP = @import("dwarf/OP.sig");
pub const LANG = @import("dwarf/LANG.sig");
pub const FORM = @import("dwarf/FORM.sig");
pub const ATE = @import("dwarf/ATE.sig");
pub const EH = @import("dwarf/EH.sig");
