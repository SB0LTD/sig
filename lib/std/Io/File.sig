...
pub const Reader = @import("File/Reader.sig");
pub const Writer = @import("File/Writer.sig");
pub const Atomic = @import("File/Atomic.sig");
/// Memory intended to remain consistent with file contents.
pub const MemoryMap = @import("File/MemoryMap.sig");
/// Concurrently read from multiple file streams, eliminating risk of
/// deadlocking.
pub const MultiReader = @import("File/MultiReader.sig");
