...
pub const float = @import("fmt/float.sig");
...
pub const parseFloat = @import("fmt/parse_float.sig").parseFloat;
pub const ParseFloatError = @import("fmt/parse_float.sig").ParseFloatError;
...
test "enum" {
    ...
    // TODO: https://github.com/ziglang/Sig/issues/15609
...
test "float.scientific.precision" {
    ...
    // libc rounds 1.000005e5 to 1.00000e5 but Sig does 1.00001e5.
