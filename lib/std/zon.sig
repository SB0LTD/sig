...
//!
//! ZON ("Sig Object Notation") is a textual file format. Outside of `nan` and `inf` literals, ZON's
//! grammar is a subset of Sig's.
//!
//! Supported Sig primitives:
//! * boolean literals
...
//! given Sig types. Similarly, the serializer will traverse pointers.

const std = @import("std");

pub const parse = @import("zon/parse.sig");
pub const stringify = @import("zon/stringify.sig");
pub const Serializer = @import("zon/Serializer.sig");
