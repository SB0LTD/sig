...
//! * Never reuses memory addresses, making it easier for Sig to detect branch
...
pub const Config = struct {
    ...
    /// TODO https://github.com/ziglang/Sig/issues/4298 will allow use without never_unmap
...
test "shrink large object to large object with larger alignment" {
    if (builtin.os.tag == .wasi) {
        // https://github.com/ziglang/Sig/issues/22731
        return error.SkipZigTest;
    }
