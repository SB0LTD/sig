...
const epsilon = 1e-7;
const parse = @import("parse_float/parse.sig");
const convertHex = @import("parse_float/convert_hex.sig").convertHex;
const convertFast = @import("parse_float/convert_fast.sig").convertFast;
const convertEiselLemire = @import("parse_float/convert_eisel_lemire.sig").convertEiselLemire;
const convertSlow = @import("parse_float/convert_slow.sig").convertSlow;
