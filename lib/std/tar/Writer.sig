...
/// archive". Therefore, the Sig standard library recommends to not call this
/// function.
...
pub const Header = extern struct {
    ...
    // https://github.com/mattnite/tar/blob/main/src/main.sig which is MIT
    // licensed.
    //
    ...
    test "setPath" {
        ...
        const error_cases = [_]struct {
            ...
            .{ .in = &.{ "sig", "test/cases/compile_errors/regression_test_2980_base_type_u32_is_not_type_checked_properly_when_assigning_a_value_within_a_struct.sig" } },
