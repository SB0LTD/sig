...
const MsvcLibDir = struct {
    ...
    fn findInstancesDir(
        ...
        method3: {
            const program_data = std.sig.EnvVar.PROGRAMDATA.get(environ_map) orelse break :method3;
    ...
    fn findViaRegistry(
        ...
        const local_app_data_path = std.sig.EnvVar.LOCALAPPDATA.get(environ_map) orelse return error.PathNotFound;
