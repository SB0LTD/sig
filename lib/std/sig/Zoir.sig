//! Sig Object Intermediate Representation.
//! Simplified AST for the ZON (Sig Object Notation) format.
...
pub const Node = union(enum) {
    ...
    pub const Index = enum(u32) {
        ...
        pub fn getAstNode(idx: Index, zoir: Zoir) std.sig.Ast.Node.Index {
    ...
    pub const Repr = struct {
        tag: Tag,
        data: u32,
        ast_node: std.sig.Ast.Node.Index,
