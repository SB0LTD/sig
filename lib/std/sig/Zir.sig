//! Sig Intermediate Representation.
//!
//! Astgen.sig converts AST nodes to these untyped IR instructions. Next,
//! Sema.sig processes these into AIR.
...
pub const Inst = struct {
    ...
    pub const Data = union {
        ...
        // bigger than expected. Note that in Debug builds, Sig is allowed
    ...
    /// 4. proto_hash: std.sig.SrcHash // if body_len != 0; hash of function prototype
    ...
    /// 9. proto_hash: std.sig.SrcHash // if body_len != 0; hash of function prototype
    ...
    pub const Declaration = struct {
        // These fields should be concatenated and reinterpreted as a `std.sig.SrcHash`.
        src_hash_0: u32,
        src_hash_1: u32,
        src_hash_2: u32,
        src_hash_3: u32,
...
pub fn getAssociatedSrcHash(zir: Zir, inst: Zir.Inst.Index) ?std.sig.SrcHash {
