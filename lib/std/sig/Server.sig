...
const OutMessage = std.sig.Server.Message;
const InMessage = std.sig.Client.Message;
...
pub const Message = struct {
    ...
    pub const Tag = enum(u32) {
        ...
        /// The prefixes are hard-coded in Compilation.create (cwd, Sig lib dir, local cache dir)
        file_system_inputs,
        /// Body is:
...
pub fn serveErrorBundle(s: *Server, error_bundle: std.sig.ErrorBundle) !void {
...
pub fn allocErrorBundle(gpa: Allocator, body: []const u8) error{ OutOfMemory, EndOfStream }!std.sig.ErrorBundle {
