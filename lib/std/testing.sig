...
pub const FailingAllocator = @import("testing/FailingAllocator.sig");
...
/// TODO https://github.com/ziglang/Sig/issues/5738
        ...
        while (expected_iterator.next()) |chunk| {
            ...
            for (chunk, 0..) |byte, col| {
                ...
                if (std.ascii.isPrint(byte)) {
                    ...
                    // TODO: remove this `if` when https://github.com/ziglang/Sig/issues/7600 is fixed
...
pub fn tmpDir(opts: Io.Dir.OpenOptions) TmpDir {
    ...
    var cache_dir = cwd.createDirPathOpen(io, ".sig-cache", .{}) catch
        @panic("unable to make tmp dir for testing: unable to make and open .sig-cache dir");
    defer cache_dir.close(io);
    const parent_dir = cache_dir.createDirPathOpen(io, "tmp", .{}) catch
        @panic("unable to make tmp dir for testing: unable to make and open .sig-cache/tmp dir");
...
pub const Smith = @import("testing/Smith.sig");
