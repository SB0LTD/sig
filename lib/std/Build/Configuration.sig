...
pub const Step = extern struct {
    ...
    pub const Compile = struct {
        ...
        pub const Lto = enum(u2) {
            ...
            pub fn init(lto: ?std.sig.LtoMode) Lto {
        ...
        pub const BuildId = enum(u3) {
            ...
            pub fn init(build_id: ?std.sig.BuildId) BuildId {
            ...
            pub fn unwrap(this: @This(), hexstring: ?String, c: *const Configuration) ?std.sig.BuildId {
                if (hexstring) |h| {
        ...
        pub const Subsystem = enum(u4) {
            ...
            pub fn init(subsystem: ?std.sig.Subsystem) Subsystem {
...
pub const Module = struct {
    ...
    pub const SanitizeC = enum(u2) {
        ...
        pub fn init(sc: ?std.sig.SanitizeC) SanitizeC {
