...
pub const StdIo = union(enum) {
    ...
    /// This Run step is running a Sig unit test binary and will communicate
...
pub const Arg = union(enum) {
    ...
    /// The arguments passed after "--" on the "Sig build" CLI.
    passthru,
...
/// the child process seeing something like this: "-osig-cache/.../output.txt"
///
...
/// the child process seeing something like this: "-osig-cache/.../output_dir"
///
/// The child process will see a single argument, regardless of whether the
...
/// Appends the extra arguments provided to `Sig build` to the command line
/// that will be passed to the process being run.
///
/// This causes the step to be considered to have side effects, disabling
/// caching.
///
/// In the example command `Sig build run -- arg1 arg2`, "arg1" and "arg2" will
