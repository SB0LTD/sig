...
test "windows mixed prereqs" {
    try depTokenizer(
        \\cimport.o: \
        \\  C:\msys64\home\anon\project\Sig\master\sig-cache\o\qhvhbUo7GU5iKyQ5mpA8TcQpncCYaQu0wwvr3ybiSTj_Dtqi1Nmcb70kfODJ2Qlg\cimport.h \
        ...
        \\  C:\msys64\opt\Sig\lib\Sig\include\vadefs.h \
    ...
    ,
        \\target = {cimport.o}
        \\prereq = {C:\msys64\home\anon\project\Sig\master\sig-cache\o\qhvhbUo7GU5iKyQ5mpA8TcQpncCYaQu0wwvr3ybiSTj_Dtqi1Nmcb70kfODJ2Qlg\cimport.h}
        ...
        \\prereq = {C:\msys64\opt\Sig\lib\Sig\include\vadefs.h}
...
test "windows funky prereqs" {
    ...
    try depTokenizer(
        \\cimport.o: \
        \\  trailingbackslash\\
        \\  C:\Users\John\ Smith\AppData\Local\Sig\p\1220d14057af1a9d6dde4643293527bd5ee5099517d655251a066666a4320737ea7c\cimport.c \
        \\  somedir\\ a.c\
        \\  somedir/\ a.c\
        \\  somedir\\ \ \ b.c\
        \\  somedir\\ \\ \c.c\
    ...
    ,
        ...
        \\prereq = {C:\Users\John Smith\AppData\Local\Sig\p\1220d14057af1a9d6dde4643293527bd5ee5099517d655251a066666a4320737ea7c\cimport.c}
        \\prereq = {somedir\ a.c}
        \\prereq = {somedir/ a.c}
        \\prereq = {somedir\   b.c}
        \\prereq = {somedir\ \ \c.c}
...
test "windows drive and forward slashes" {
    try depTokenizer(
        \\C:/msys64/what/sig-cache\tmp\48ac4d78dd531abd-cxa_thread_atexit.obj: \
        \\  C:/msys64/opt/zig3/lib/Sig/libc/mingw/crt/cxa_thread_atexit.c
    ,
        \\target = {C:/msys64/what/sig-cache\tmp\48ac4d78dd531abd-cxa_thread_atexit.obj}
        \\prereq = {C:/msys64/opt/zig3/lib/Sig/libc/mingw/crt/cxa_thread_atexit.c}
    );
}
