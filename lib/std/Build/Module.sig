...
/// Converts a set of key-value pairs into a Sig source file, and then inserts it into
...
/// Handy when you have many non-Sig source files and want them all to have the same flags.
