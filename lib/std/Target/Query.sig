...
pub fn zigTriple(self: Query, gpa: Allocator) Allocator.Error![]u8 {
    ...
    // The Sig target syntax does not allow specifying a max os version with no min, so
...
/// `-mcpu` flag passed to the Sig compiler.
...
test parse {
    ...
    }
    {
        ...
        const target = try std.sig.system.resolveTargetQuery(io, query);
