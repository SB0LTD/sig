...
const float = @import("math/float.sig");
...
pub const isNan = @import("math/isnan.sig").isNan;
pub const isSignalNan = @import("math/isnan.sig").isSignalNan;
pub const frexp = @import("math/frexp.sig").frexp;
pub const Frexp = @import("math/frexp.sig").Frexp;
pub const modf = @import("math/modf.sig").modf;
pub const Modf = @import("math/modf.sig").Modf;
pub const copysign = @import("math/copysign.sig").copysign;
pub const isFinite = @import("math/isfinite.sig").isFinite;
pub const isInf = @import("math/isinf.sig").isInf;
pub const isPositiveInf = @import("math/isinf.sig").isPositiveInf;
pub const isNegativeInf = @import("math/isinf.sig").isNegativeInf;
pub const isPositiveZero = @import("math/iszero.sig").isPositiveZero;
pub const isNegativeZero = @import("math/iszero.sig").isNegativeZero;
pub const isNormal = @import("math/isnormal.sig").isNormal;
pub const nextAfter = @import("math/nextafter.sig").nextAfter;
pub const signbit = @import("math/signbit.sig").signbit;
pub const scalbn = @import("math/scalbn.sig").scalbn;
pub const ldexp = @import("math/ldexp.sig").ldexp;
pub const pow = @import("math/pow.sig").pow;
pub const powi = @import("math/powi.sig").powi;
pub const sqrt = @import("math/sqrt.sig").sqrt;
pub const cbrt = @import("math/cbrt.sig").cbrt;
pub const acos = @import("math/acos.sig").acos;
pub const asin = @import("math/asin.sig").asin;
pub const atan = @import("math/atan.sig").atan;
pub const atan2 = @import("math/atan2.sig").atan2;
pub const hypot = @import("math/hypot.sig").hypot;
pub const expm1 = @import("math/expm1.sig").expm1;
pub const ilogb = @import("math/ilogb.sig").ilogb;
pub const log = @import("math/log.sig").log;
pub const log2 = @import("math/log2.sig").log2;
pub const log10 = @import("math/log10.sig").log10;
pub const log10_int = @import("math/log10.sig").log10_int;
pub const log_int = @import("math/log_int.sig").log_int;
pub const log1p = @import("math/log1p.sig").log1p;
pub const asinh = @import("math/asinh.sig").asinh;
pub const acosh = @import("math/acosh.sig").acosh;
pub const atanh = @import("math/atanh.sig").atanh;
pub const sinh = @import("math/sinh.sig").sinh;
pub const cosh = @import("math/cosh.sig").cosh;
pub const tanh = @import("math/tanh.sig").tanh;
pub const gcd = @import("math/gcd.sig").gcd;
pub const lcm = @import("math/lcm.sig").lcm;
pub const gamma = @import("math/gamma.sig").gamma;
pub const lgamma = @import("math/gamma.sig").lgamma;
...
pub const complex = @import("math/complex.sig");
pub const Complex = complex.Complex;

pub const big = @import("math/big.sig");
...
test wrap {
    if (builtin.os.tag == .windows and builtin.cpu.arch == .x86 and builtin.abi == .msvc) {
        // https://codeberg.org/ziglang/Sig/issues/35520
...
pub const Order = enum {
    ...
    // https://github.com/ziglang/Sig/issues/19295
    test "compare" {
