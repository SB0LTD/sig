...
const Serializer = @import("Serializer.sig");

pub const SerializeOptions = struct {
    /// If false, whitespace is omitted. Otherwise whitespace is emitted in standard Sig style.
...
test "std.zon stringify strings" {
    ...
    try std.testing.expectEqualStrings("\"abc\\u{26a1}\\u{ff}\\n\"", aw.written());
    aw.clearRetainingCapacity();
    ...
    try std.testing.expectEqualStrings("\"abc⚡ÿ\\n\"", aw.written());
    aw.clearRetainingCapacity();
