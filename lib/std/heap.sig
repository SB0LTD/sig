...
pub const ArenaAllocator = @import("heap/ArenaAllocator.sig");
pub const SmpAllocator = @import("heap/SmpAllocator.sig");
pub const SafeAllocator = @import("heap/SafeAllocator.sig");
pub const FixedBufferAllocator = @import("heap/FixedBufferAllocator.sig");
pub const BufferFirstAllocator = @import("heap/BufferFirstAllocator.sig");
pub const PageAllocator = @import("heap/PageAllocator.sig");
pub const WasmAllocator = if (builtin.single_threaded) BrkAllocator else @compileError("unimplemented");
pub const BrkAllocator = @import("heap/BrkAllocator.sig");

/// Deprecated; use `SafeAllocator.Options`.
pub const DebugAllocatorConfig = @import("heap/debug_allocator.sig").Config;
/// Deprecated; use `SafeAllocator`.
pub const DebugAllocator = @import("heap/debug_allocator.sig").DebugAllocator;
/// Deprecated.
...
pub const memory_pool = @import("heap/memory_pool.sig");
