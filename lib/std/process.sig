...
pub const Child = @import("process/Child.sig");
pub const Args = @import("process/Args.sig");
pub const Environ = @import("process/Environ.sig");
pub const Preopens = @import("process/Preopens.sig");
...
///
/// Completion of https://github.com/ziglang/Sig/issues/24510 will also allow
...
pub const SpawnOptions = struct {
    ...
    pub const StdIo = union(enum) {
        ...
        /// - Sig's std.Io.File.stdout() assumes blocking mode
...
pub fn abort() noreturn {
    ...
    // See https://github.com/ziglang/Sig/issues/2071 for more details.
