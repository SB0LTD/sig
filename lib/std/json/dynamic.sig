...
const ParseError = @import("./static.sig").ParseError;

const isNumberFormattedLikeAnInteger = @import("Scanner.sig").isNumberFormattedLikeAnInteger;
