...
/// Controls how to deal with various inconsistencies between the JSON document and the Sig struct type passed in.
/// For duplicate fields or unknown fields, set options in this struct.
/// For missing fields, give the Sig struct fields default values.
