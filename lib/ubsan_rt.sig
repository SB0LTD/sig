...
comptime {
    ...
    // these checks are nearly impossible to replicate in Sig, as they rely on nuances
    ...
    // we disable -fsanitize=function for reasons explained in src/Compilation.sig
