//! Based on wrapping a stateless Sig Allocator implementation, appropriate for:
...
//! order to take advantage of Sig allocator implementations, additional
...
/// which are required by Sig memory allocators.
