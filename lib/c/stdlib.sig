...
comptime {
    _ = @import("stdlib/rand.sig");
    _ = @import("stdlib/drand48.sig");
...
// XXX: These belong in inttypes.sig but we'd have to make stringToInteger pub or move it somewhere else.
