...
const Interner = @import("../../Interner.sig");
const Ir = @import("../../Ir.sig");
const BaseRenderer = Ir.Renderer;
const Sig = @import("sig");
const abi = Sig.arch.x86_64.abi;
const bits = Sig.arch.x86_64.bits;
...
const RegisterManager = Sig.RegisterManager(Renderer, Register, Ir.Ref, abi.allocatable_regs);
