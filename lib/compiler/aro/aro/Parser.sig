...
const Attribute = @import("Attribute.sig");
const Builtins = @import("Builtins.sig");
const evalBuiltin = @import("Builtins/eval.sig").eval;
const char_info = @import("char_info.sig");
const Compilation = @import("Compilation.sig");
const Diagnostics = @import("Diagnostics.sig");
const InitList = @import("InitList.sig");
const Preprocessor = @import("Preprocessor.sig");
const record_layout = @import("record_layout.sig");
const Source = @import("Source.sig");
const StringId = @import("StringInterner.sig").StringId;
const SymbolStack = @import("SymbolStack.sig");
const Symbol = SymbolStack.Symbol;
const text_literal = @import("text_literal.sig");
const Tokenizer = @import("Tokenizer.sig");
const Tree = @import("Tree.sig");
...
pub const Diagnostic = @import("Parser/Diagnostic.sig");
...
const Escaped = struct {
    ...
    pub fn format(ctx: Escaped, w: *std.Io.Writer, fmt: []const u8) !usize {
        ...
        try std.sig.stringEscape(ctx.str, w);
        return i;
    }
};
