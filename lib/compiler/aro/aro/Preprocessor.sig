...
const features = @import("features.sig");
const Hideset = @import("Hideset.sig");
...
pub const Diagnostic = @import("Preprocessor/Diagnostic.sig");
...
/// Like `std.sig.fmtEscapes`, but for C strings. Hex escapes are used for any
