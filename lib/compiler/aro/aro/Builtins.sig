...
const LangOpts = @import("LangOpts.sig");
const Parser = @import("Parser.sig");
const Target = @import("Target.sig");
const TypeStore = @import("TypeStore.sig");
const QualType = TypeStore.QualType;
const Builder = TypeStore.Builder;
const TypeDescription = @import("Builtins/TypeDescription.sig");
const properties = @import("Builtins/properties.sig");
...
const aarch64 = @import("Builtins/aarch64.sig").with(BuiltinTarget);
const amdgcn = @import("Builtins/amdgcn.sig").with(BuiltinTarget);
const arm = @import("Builtins/arm.sig").with(BuiltinTarget);
const bpf = @import("Builtins/bpf.sig").with(BuiltinTarget);
const common = @import("Builtins/common.sig").with(BuiltinBase);
const hexagon = @import("Builtins/hexagon.sig").with(BuiltinTarget);
const loongarch = @import("Builtins/loongarch.sig").with(BuiltinTarget);
const mips = @import("Builtins/mips.sig").with(BuiltinBase);
const nvptx = @import("Builtins/nvptx.sig").with(BuiltinTarget);
const powerpc = @import("Builtins/powerpc.sig").with(BuiltinTarget);
const riscv = @import("Builtins/riscv.sig").with(BuiltinTarget);
const s390x = @import("Builtins/s390x.sig").with(BuiltinTarget);
const ve = @import("Builtins/ve.sig").with(BuiltinBase);
const x86_64 = @import("Builtins/x86_64.sig").with(BuiltinTarget);
const x86 = @import("Builtins/x86.sig").with(BuiltinTarget);
const xcore = @import("Builtins/xcore.sig").with(BuiltinBase);
