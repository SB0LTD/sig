...
const Pragma = @import("Pragma.sig");
const record_layout = @import("record_layout.sig");
const Source = @import("Source.sig");
const StringInterner = @import("StringInterner.sig");
...
fn writeBuiltinMacros(comp: *Compilation, system_defines_mode: SystemDefinesMode, w: *Io.Writer) !void {
    if (system_defines_mode == .include_system_defines) {
        ...
        ++ " " ++ @import("../backend.sig").version_str ++ "\"\n" ++
            \\#define __Aro__
            \\
        );
    }
