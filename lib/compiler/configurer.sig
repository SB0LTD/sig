...
pub fn main(init: process.Init.Minimal) !void {
    ...
    const zig_exe = expectArgOrFatal(args, &arg_i, "--Sig");
    ...
    const NO_COLOR = std.sig.EnvVar.NO_COLOR.isSet(&graph.environ_map);
    const CLICOLOR_FORCE = std.sig.EnvVar.CLICOLOR_FORCE.isSet(&graph.environ_map);
