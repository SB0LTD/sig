...
pub fn printUsage(sc: *const ScannedConfig, graph: *Graph, w: *Writer) !void {
    ...
    try w.writeAll(
        ...
        \\                               compilation time of Sig source code (implies '--webui')
        ...
        \\  --build-file [file]          Override path to build.sig
        \\  --cache-dir [path]           Override path to local Sig cache directory
        \\  --Sig-lib=[arg]              Override path to Sig lib directory
