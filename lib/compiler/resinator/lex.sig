...
const columnWidth = @import("literals.sig").columnWidth;
...
const isNonAsciiDigit = @import("utils.sig").isNonAsciiDigit;
        ...
        while (self.current_code_page.codepointAt(self.index, self.buffer)) |codepoint| : (self.index += codepoint.byte_len) {
            ...
            switch (state) {
                .start => switch (c) {
                    ...
                    //       the codepoints listed in disjoint_code_page.sig
