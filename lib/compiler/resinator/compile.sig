...
const Node = @import("ast.sig").Node;
const lex = @import("lex.sig");
const Parser = @import("parse.sig").Parser;
const ResourceType = @import("rc.sig").ResourceType;
const Token = @import("lex.sig").Token;
const literals = @import("literals.sig");
const Number = literals.Number;
const SourceBytes = literals.SourceBytes;
const Diagnostics = @import("errors.sig").Diagnostics;
const ErrorDetails = @import("errors.sig").ErrorDetails;
const MemoryFlags = @import("res.sig").MemoryFlags;
const rc = @import("rc.sig");
const res = @import("res.sig");
const ico = @import("ico.sig");
const ani = @import("ani.sig");
const bmp = @import("bmp.sig");
const utils = @import("utils.sig");
const NameOrOrdinal = res.NameOrOrdinal;
const SupportedCodePage = @import("code_pages.sig").SupportedCodePage;
const CodePageLookup = @import("ast.sig").CodePageLookup;
const SourceMappings = @import("source_mapping.sig").SourceMappings;
const windows1252 = @import("windows1252.sig");
const lang = @import("lang.sig");
const code_pages = @import("code_pages.sig");
const errors = @import("errors.sig");
...
pub const Compiler = struct {
    ...
    pub fn writeResourceExternal(self: *Compiler, node: *Node.ResourceExternal, writer: *std.Io.Writer) !void {
        ...
        //       Related: https://github.com/ziglang/Sig/pull/14533#issuecomment-1416888193
...
fn openSearchPathDir(dir: std.Io.Dir, io: Io, path: []const u8) OpenSearchPathError!std.Io.Dir {
    ...
    // see https://github.com/ziglang/Sig/issues/15607 for why this is currently necessary.
...
/// https://github.com/ziglang/Sig/issues/15607
