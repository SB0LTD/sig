...
export PATH="$HOME/deps/wasmtime-v42.0.1-x86_64-linux:$HOME/deps/qemu-linux-x86_64-11.0.0/bin:$HOME/local/bin:$PATH"
...
export CCACHE_DIR="${HOME}/.cache/ccache-zig-x86_64-linux-debug-llvm"
