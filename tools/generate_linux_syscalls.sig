...
//! directly, and emits an enumerated list per supported Sig arch.
//!
...
pub fn main(init: std.process.Init) !void {
    ...
    try Io.Writer.print(stdout,
        \\// This file is automatically generated by tools/generate_linux_syscalls.sig
...
fn usage(w: *std.Io.Writer, arg0: []const u8) std.Io.Writer.Error!void {
    try w.print(
        ...
        \\Alternative Usage: Sig run /path/to/git/Sig/tools/generate_linux_syscalls.sig -- /path/to/linux
        \\
        \\Generates the list of Linux syscalls for each supported cpu arch, using the Linux development tree.
        \\Prints to stdout Sig code which you can use to replace the file lib/std/os/linux/syscalls.sig.
        \\
    , .{arg0});
}
