// Sig run this file inside the test_parsing/ directory of this repo: https://github.com/nst/JSONTestSuite
...
pub fn main(init: std.process.Init) !void {
    ...
    try output.writeAll(
        \\//! This file was generated by _generate_JSONTestSuite.sig
        \\//! These test cases are sourced from: https://github.com/nst/JSONTestSuite
        \\const ok = @import("./test.sig").ok;
        \\const err = @import("./test.sig").err;
        \\const any = @import("./test.sig").any;
        \\
        \\
    );
...
fn writeString(writer: anytype, s: []const u8) !void {
    if (s.len > 200) {
        // There are a few of these we can compress with Sig expressions.
