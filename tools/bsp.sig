//! CLI tool to interface with the build system protocol (Sig build --listen=-)
...
pub fn main(init: std.process.Init) !void {
    ...
    if (maker_args.items.len < 1) try maker_args.append(arena, "sig");
    ...
    log.debug("cmd: {f}", .{std.sig.SubprocessCommand{
